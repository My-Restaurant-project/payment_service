...
type PaymentRepository interface {
	CreatePayment(req *pay.CreatePaymentRequest) (*pay.CreatePaymentResponse, error)
	GetPayment(req *pay.GetPaymentRequest) (*pay.GetPaymentResponse, error)
	ListPayments(req *pay.ListPaymentsRequest) (*pay.ListPaymentsResponse, error)
	UpdatePayment(req *pay.UpdatePaymentRequest) (*pay.UpdatePaymentResponse, error)
	DeletePayment(req *pay.DeletePaymentRequest) (*pay.DeletePaymentResponse, error)
}
