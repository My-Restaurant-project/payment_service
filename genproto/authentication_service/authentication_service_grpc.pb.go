...
const (
	AuthenticationService_Login_FullMethodName          = "/auth_service.authentication_service/login"
	AuthenticationService_Register_FullMethodName       = "/auth_service.authentication_service/register"
	AuthenticationService_GetProfileById_FullMethodName = "/auth_service.authentication_service/get_profile_by_id"
)
...
func (c *authenticationServiceClient) GetProfileById(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*UserIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthenticationService_GetProfileById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthenticationService_GetProfileById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_GetProfileById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
